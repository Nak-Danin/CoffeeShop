...
import image from "../assets/images/favorites.png";
const Favorites = () => {
  return (
    <>
      ...
      <main className="w-full flex flex-col ps-[30px] md:ps-[200px] lg:ps-[300px] gap-5 py-[50px]">
        <div className="flex flex-col gap-5 w-[300px] md:w-[400px]">
          <h1 className="font-bold text-[20px] md:text-[25px]">Favorites</h1>
