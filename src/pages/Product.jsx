...
const Product = () => {
  ...
  return (
    <main className="w-full h-full">
      <nav className="sticky z-[9] top-[66px] md:top-[100px] lg:top-0 w-full flex gap-1 bg-[#F9F9F9] py-3 ps-[30px] lg:ps-[120px] text-[16px] border-y-[1px] border-gray-300 tracking-wide font-[Roboto_Condensed]">
      ...
      <main className="w-full h-fit py-[30px] flex flex-col lg:flex-row bg-[#1F3933]">
        ...
        <aside className="flex flex-col justify-center items-center lg:items-baseline w-full lg:w-1/2">
          <h1 className="font-bold text-[25px] md:text-[35px] lg:text-[40px] text-white">{foundItem.name}</h1>
          <span className="text-gray-300 text-[25px] font-medium tracking-wide">
            {foundItem.nutrition.calories[size]} calories
          </span>
          <span className="text-gray-300 text-[25px] font-medium tracking-wide mt-5">$ {foundItem.price}</span>
        </aside>
      </main>
      ...
      <main className="ps-[30px] lg:ps-[120px] w-full bg-[#1F3933] flex flex-col gap-3 py-[30px] text-[#BCC4C2]">
        ...
        <span className="w-[40%] font-[Roboto_Condensed]">
